            ...
            <div className="flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className="md:w-1/2 p-12 md:p-20 relative flex items-center overflow-hidden" data-aos="fade-right">
                    ...
                    <div className="absolute inset-0 z-0">
                        <img src="https://picsum.photos/seed/vision/800/800?abstract" alt="Creative" className="w-full h-full object-cover transition-transform duration-1000 hover:scale-110" />
